...
def _readme(project: str, fields: list, permset_name: str, alias: str,
            ...
            tab_names: list = None, base_path: str = None) -> str:
    project_path = base_project_path(project, base_path) if base_path else base_project_path(project)
    lines = [
        ...
        f'  {project_path}\\force-app\\main\\default\\...',
        '',
        'Components:',
    ]
...
def build_package_zip(project: str, fields: list, permset: dict = None,
                      ...
                      profiles: list = None, base_path: str = None) -> tuple:
